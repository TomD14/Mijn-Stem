    ...
    return (
            <div className="sidebar">
                ...
                <a className={currCount === 0 && 'active'} href="#home" onClick={() => onClickTab(0)}>
                    <span className={currCount === 0 && 'text-active'}><i className="fas fa-arrow-right"></i> Home</span>
                </a>
                <a className={currCount === 1 && 'active'} href="#news" onClick={() => onClickTab(1)}>
                    <span className={currCount === 1 && 'text-active'}><i className="fas fa-arrow-right"></i> News</span>
                </a>
                <a className={currCount === 2 && 'active'} href="#contact" onClick={() => onClickTab(2)}>
                    <span className={currCount === 2 && 'text-active'}><i className="fas fa-arrow-right"></i> Contact</span>
                </a>
                <a className={currCount === 3 && 'active'} href="#about" onClick={() => onClickTab(3)}>
                    <span className={currCount === 3 && 'text-active'}><i className="fas fa-arrow-right"></i> About</span>
                </a>
            </div>
    )
}
